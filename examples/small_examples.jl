...
function display_tetrahedron(example_id = "tetra_1_1_1_1")
    ...
    interface_surface = DelaunayInterfaces.InterfaceSurface(points, color_labels)
    display(DelaunayInterfaces.get_interface_figure(interface_surface, points, color_labels; show_multicolored_points = true, show_multicolored_edges = true))
end
...
function display_all_tetrahedra()
    ...
    interface_A = DelaunayInterfaces.InterfaceSurface(points_A, color_labels_A)
    DelaunayInterfaces.draw_interface_to_scene!(scene_A, interface_A, points_A, color_labels_A, Vector{Float64}(); 
    ...
    interface_B = DelaunayInterfaces.InterfaceSurface(points_B, color_labels_B)
    DelaunayInterfaces.draw_interface_to_scene!(scene_B, interface_B, points_B, color_labels_B, Vector{Float64}(); 
    show_wireframe=true, show_multicolored_edges=true, show_multicolored_points=true, interface_colormap=interface_colormap)
    ...
    interface_C = DelaunayInterfaces.InterfaceSurface(points_C, color_labels_C)
    DelaunayInterfaces.draw_interface_to_scene!(scene_C, interface_C, points_C, color_labels_C, Vector{Float64}(); 
    show_wireframe=true, show_multicolored_edges=true, show_multicolored_points=true, interface_colormap=interface_colormap)
    ...
    interface_D = DelaunayInterfaces.InterfaceSurface(points_D, color_labels_D)
    DelaunayInterfaces.draw_interface_to_scene!(scene_D, interface_D, points_D, color_labels_D, Vector{Float64}(); 
    show_wireframe=true, show_multicolored_edges=true, show_multicolored_points=true, interface_colormap=interface_colormap)
...
function display_example_sequence(keys = ["tetra_3_1", "tetra_2_2", "tetra_2_1_1", "tetra_1_1_1_1", "sheet_3_3"])
    ...
    interface_surfaces = [DelaunayInterfaces.InterfaceSurface(p,l) for (p,l) in zip(points_sequence, labels_sequence)]

    display(DelaunayInterfaces.get_interface_sequence_figure(
        interface_surfaces,
        points_sequence,
        labels_sequence,
