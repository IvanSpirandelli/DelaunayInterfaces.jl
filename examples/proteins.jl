...
function display_protein_protein_interface(example_id = "4bmg_dimer"; solvent_radius = 1.4, show_wireframe = false)
    points, color_labels, radii = get_example_data(example_id)
    sas_radii = radii .+ solvent_radius
    interface_surface = TopologicalInterfaces.InterfaceSurface(points, color_labels, sas_radii)
...
function display_protein_protein_interface_and_space_filling_diagram(example_id = "4bmg_dimer"; solvent_radius = 1.4, show_wireframe = false)
    points, color_labels, radii = get_example_data(example_id)
    sas_radii = radii .+ solvent_radius
    interface_surface = TopologicalInterfaces.InterfaceSurface(points, color_labels, sas_radii)
...
function display_protein_protein_interface_filtration(example_id = "4bmg_dimer"; solvent_radius = 1.4, show_wireframe = false)
    points, color_labels, radii = get_example_data(example_id)
    sas_radii = radii .+ solvent_radius
    interface_surface = TopologicalInterfaces.InterfaceSurface(points, color_labels, sas_radii)
